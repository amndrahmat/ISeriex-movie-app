...
const MoviesLayout = () => {
  ...
  useEffect(() => {
    ...
    getMovies();
  }, [API_KEY, getLastMovies, handleAddError]);
                    ...
                    >
                      ...
                      <div>
                        <p
                          className={
                            isMobile
                              ? "text-[#3A69DF] font-sans font-medium text-xs w-full py-2 leading-4 uppercase text-center"
                              : "text-[#3A69DF] font-sans font-medium text-xs w-44 py-2 leading-4 uppercase text-center"
                              ? isTablet
                                ? "text-[#3A69DF] font-sans font-medium text-xs w-28 py-2 leading-4 uppercase text-start "
                                : "text-[#3A69DF] font-sans font-medium text-xs w-44 py-2 leading-4 uppercase text-center"
                              : "text-[#3A69DF] font-sans font-medium text-xs w-44 py-2 leading-4 uppercase text-center"
                          }
                        >
