                ...
                <div className="flex items-center relative ">
                  ...
                  <div className="ml-4">
                    <p
                      className={
                        isMobile
                          ? "font-sans font-bold text-white text-xs overflow-hidden leading-6"
                          : "font-sans font-bold text-white overflow-hidden text-base leading-6"
                      }
                    >
                      {movie.original_name}
                    </p>
                      ...
                      >
                        ...
                        >
                          <div
                            className={`${
                              index < 9
                                ? "absolute scale-150 text-[#222c38] font-sans left-0 bottom-10 text-8xl font-bold -z-10"
                                : "absolute scale-150 text-[#222c38] font-sans -left-8 bottom-10 text-8xl font-bolds -z-10"
                            }`}
                          >
                            {index + 1}
                          </div>
