    ...
    <div className="w-full ">
      <div className="relative ">
        ...
        <input
          ...
          className={
            isDesktop
              ? "w-full font-sans text-white rounded-lg text-sm py-1 bg-[#3A69DF] pl-8 outline-none"
              : "w-full grow font-sans text-white rounded-lg text-sm py-1 bg-[#3A69DF] pl-8 outline-none"
          }
        ></input>
      </div>
      <div
          ...
          <div className="flex items-center border border-white bg-background-dark p-2 w-full rounded-md">
            ...
            >
              ...
              <div className="pl-6">
                <p
                  className={
                    "font-sans font-bold text-white overflow-hidden text-sm leading-6"
                  }
                >
